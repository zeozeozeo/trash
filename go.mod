module github.com/zeozeozeo/trash

go 1.25

require (
	github.com/TheGreatRambler/goldmark-chart v0.0.0-20251125193418-7d13dde0eb68
	...
	github.com/zeozeozeo/goldmark-enclave v0.0.0-20250831105210-15772ec7f996
